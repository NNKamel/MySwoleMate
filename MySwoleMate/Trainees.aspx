                ...
                <div class="col-lg-12 text-center">
                    <asp:GridView ID="TraineeList" runat="server" CssClass="table table-bordered text-left"
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField runat="server" DataNavigateUrlFields="~/AssignWorkout.aspx?TraineeID={0}" ControlStyle-CssClass="btn btn-success btn-xs" ItemStyle-CssClass="text-center"/>
                        </Columns>
                    </asp:GridView>
                </div>
            </div>
