        ...
        <div class="container" >
            ...
            <div class="form-horizontal">
                <div class="form-group">
                    <asp:Label ID="Exercise1Label" runat="server" Text="Exercise 1" AssociatedControlID="Exercise1" CssClass="col-xs-4 control-label" ></asp:Label>
                    <div class="col-xs-4">
                        <asp:TextBox ID="Exercise1" runat="server" CssClass="form-control" TextMode="SingleLine" MaxLength="30"></asp:TextBox>
                    </div>
                    <div class="has-error">
                        <span class="help-block">
                            <asp:RequiredFieldValidator ID="Exercise1Required" runat="server" ErrorMessage="Exercise1 Required" ControlToValidate="Exercise1" Display="Dynamic" ValidationGroup="AllValidators"></asp:RequiredFieldValidator>
                        </span>
                    </div>
                </div>
                <div class="form-group">
                    <asp:Label ID="Exercise1SetsLabel" runat="server" Text="Exercise 1 Sets" AssociatedControlID="Exercise1Sets" CssClass="col-xs-4 control-label" ></asp:Label>
                    <div class="col-xs-4">
                ...
                <div class="form-group">
                    <asp:Label ID="Exercise1RepsLabel" runat="server" Text="Exercise 1 Reps" AssociatedControlID="Exercise1Reps" CssClass="col-xs-4 control-label" ></asp:Label>
                    <div class="col-xs-4">
                ...
                <div class="form-group">
                    <asp:Label ID="Exercise2Label" runat="server" Text="Exercise 2" AssociatedControlID="Exercise2" CssClass="col-xs-4 control-label" ></asp:Label>
                    <div class="col-xs-4">
                        <asp:TextBox ID="Exercise2" runat="server" CssClass="form-control" TextMode="SingleLine" MaxLength="30"></asp:TextBox>
                    </div>
                    <div class="has-error">
                        <span class="help-block">
                            <asp:RequiredFieldValidator ID="Exercise2Required" runat="server" ErrorMessage="Exercise2 Required" ControlToValidate="Exercise2" Display="Dynamic" ValidationGroup="AllValidators"></asp:RequiredFieldValidator>
                        </span>
                    </div>
                </div>
                <div class="form-group">
                    <asp:Label ID="Exercise2SetsLabel" runat="server" Text="Exercise 2 Sets" AssociatedControlID="Exercise2Sets" CssClass="col-xs-4 control-label" ></asp:Label>
                    <div class="col-xs-4">
                ...
                <div class="form-group">
                    <asp:Label ID="Exercise2RepsLabel" runat="server" Text="Exercise 2 Reps" AssociatedControlID="Exercise2Reps" CssClass="col-xs-4 control-label" ></asp:Label>
                    <div class="col-xs-4">
                ...
                <div class="form-group">
                    <asp:Label ID="Exercise3Label" runat="server" Text="Exercise 3" AssociatedControlID="Exercise3" CssClass="col-xs-4 control-label" ></asp:Label>
                    <div class="col-xs-4">
                        <asp:TextBox ID="Exercise3" runat="server" CssClass="form-control" TextMode="SingleLine" MaxLength="30"></asp:TextBox>
                    </div>
                    <div class="has-error">
                        <span class="help-block">
                            <asp:RequiredFieldValidator ID="Exercise3Required" runat="server" ErrorMessage="Exercise3 Required" ControlToValidate="Exercise3" Display="Dynamic" ValidationGroup="AllValidators"></asp:RequiredFieldValidator>
                        </span>
                    </div>
                </div>
                <div class="form-group">
                    <asp:Label ID="Exercise3SetsLabel" runat="server" Text="Exercise 3 Sets" AssociatedControlID="Exercise3Sets" CssClass="col-xs-4 control-label" ></asp:Label>
                    <div class="col-xs-4">
                ...
                <div class="form-group">
                    <asp:Label ID="Exercise3RepsLabel" runat="server" Text="Exercise 3 Reps" AssociatedControlID="Exercise3Reps" CssClass="col-xs-4 control-label" ></asp:Label>
                    <div class="col-xs-4">
                ...
                <div class="form-group">
                    <asp:Label ID="Exercise4Label" runat="server" Text="Exercise 4" AssociatedControlID="Exercise4" CssClass="col-xs-4 control-label" ></asp:Label>
                    <div class="col-xs-4">
                        <asp:TextBox ID="Exercise4" runat="server" CssClass="form-control" TextMode="SingleLine" MaxLength="30"></asp:TextBox>
                    </div>
                    <div class="has-error">
                        <span class="help-block">
                            <asp:RequiredFieldValidator ID="Exercise4Required" runat="server" ErrorMessage="Exercise4 Required" ControlToValidate="Exercise4" Display="Dynamic" ValidationGroup="AllValidators"></asp:RequiredFieldValidator>
                        </span>
                    </div>
                </div>
                <div class="form-group">
                    <asp:Label ID="Exercise4SetsLabel" runat="server" Text="Exercise 4 Sets" AssociatedControlID="Exercise4Sets" CssClass="col-xs-4 control-label" ></asp:Label>
                    <div class="col-xs-4">
                ...
                <div class="form-group">
                    <asp:Label ID="Exercise4RepsLabel" runat="server" Text="Exercise 4 Reps" AssociatedControlID="Exercise4Reps" CssClass="col-xs-4 control-label" ></asp:Label>
                    <div class="col-xs-4">
                ...
                <div class="form-group">
                    <asp:Label ID="Exercise5Label" runat="server" Text="Exercise 5" AssociatedControlID="Exercise5" CssClass="col-xs-4 control-label" ></asp:Label>
                    <div class="col-xs-4">
                        <asp:TextBox ID="Exercise5" runat="server" CssClass="form-control" TextMode="SingleLine" MaxLength="30"></asp:TextBox>
                    </div>
                    <div class="has-error">
                        <span class="help-block">
                            <asp:RequiredFieldValidator ID="Exercise5Required" runat="server" ErrorMessage="Exercise5 Required" ControlToValidate="Exercise5" Display="Dynamic" ValidationGroup="AllValidators"></asp:RequiredFieldValidator>
                        </span>
                    </div>
                </div>
                <div class="form-group">
                    <asp:Label ID="Exercise5SetsLabel" runat="server" Text="Exercise 5 Sets" AssociatedControlID="Exercise5Sets" CssClass="col-xs-4 control-label" ></asp:Label>
                    <div class="col-xs-4">
                ...
                <div class="form-group">
                    <asp:Label ID="Exercise5RepsLabel" runat="server" Text="Exercise 5 Reps" AssociatedControlID="Exercise5Reps" CssClass="col-xs-4 control-label" ></asp:Label>
                    <div class="col-xs-4">
